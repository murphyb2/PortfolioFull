...
ALLOWED_HOSTS = [
    'localhost',
    '127.0.0.1',
    'devportfolio-env.eba-rrmu3p2d.us-east-1.elasticbeanstalk.com',
...
ROOT_URLCONF = 'PortfolioFull.urls'
...
WSGI_APPLICATION = 'PortfolioFull.wsgi.application'
